...
public class SamplesCommonPlugin extends AbstractUIPlugin {

	private static SamplesCommonPlugin _plugin;
	 ...
	 * @return the default
	 */
	public static SamplesCommonPlugin getDefault() {
		return _plugin;
	}
