...
public class AddContainmentConnectionFeature extends
		AbstractAddFeature implements IAddFeature {
	...
	public PictogramElement add(IAddContext context) {
		...
		Connection connection = peCreateService.createCurvedConnection(
				new double[] { 0d, 0d, 0.5d, -50d, 1d, 0d }, getDiagram());
