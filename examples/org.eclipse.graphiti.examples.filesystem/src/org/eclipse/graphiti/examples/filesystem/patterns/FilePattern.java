...
public class FilePattern extends IdPattern implements IPattern {
	...
	protected boolean layout(IdLayoutContext context, String id) {
		...
		if (id.equals(ID_MAIN_RECTANGLE)) {
			GraphicsAlgorithm mainRectangle = context.getGraphicsAlgorithm();
			Graphiti.getGaService().setLocationAndSize(mainRectangle, 0, 10, outerRectangle.getWidth(),
					outerRectangle.getHeight() - 10);
			changesDone = true;
		} else if (id.equals(ID_NAME_TEXT)) {
			GraphicsAlgorithm nameText = context.getGraphicsAlgorithm();
			Graphiti.getGaService().setLocationAndSize(nameText, 0, 10, outerRectangle.getWidth(),
					outerRectangle.getHeight() - 10);
			changesDone = true;
		}
