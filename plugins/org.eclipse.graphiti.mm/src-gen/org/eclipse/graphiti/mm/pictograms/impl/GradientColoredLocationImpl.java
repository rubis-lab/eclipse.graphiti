 ...
 * </copyright>
 *
 * $Id: GradientColoredLocationImpl.java,v 1.1 2010/07/21 12:34:45 jpasch Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.graphiti.mm.pictograms.impl.GradientColoredLocationImpl#getLocationType <em>Location Type</em>}</li>
 *   <li>{@link org.eclipse.graphiti.mm.pictograms.impl.GradientColoredLocationImpl#getLocationValue <em>Location Value</em>}</li>
 *   <li>{@link org.eclipse.graphiti.mm.pictograms.impl.GradientColoredLocationImpl#getColor <em>Color</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GradientColoredLocationImpl extends EObjectImpl implements GradientColoredLocation {
	...
	protected EClass eStaticClass() {
		return PictogramsPackage.Literals.GRADIENT_COLORED_LOCATION;
	}
	...
	public void setLocationType(LocationType newLocationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PictogramsPackage.GRADIENT_COLORED_LOCATION__LOCATION_TYPE, oldLocationType, locationType));
	}
	...
	public void setLocationValue(Integer newLocationValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PictogramsPackage.GRADIENT_COLORED_LOCATION__LOCATION_VALUE, oldLocationValue, locationValue));
	}
	...
	public Color getColor() {
		if (color != null && color.eIsProxy()) {
			...
			if (color != oldColor) {
				...
				NotificationChain msgs = oldColor.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PictogramsPackage.GRADIENT_COLORED_LOCATION__COLOR, null, null);
				if (newColor.eInternalContainer() == null) {
					msgs = newColor.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PictogramsPackage.GRADIENT_COLORED_LOCATION__COLOR, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PictogramsPackage.GRADIENT_COLORED_LOCATION__COLOR, oldColor, color));
			}
		}
		return color;
	}
	...
	public NotificationChain basicSetColor(Color newColor, NotificationChain msgs) {
		...
		color = newColor;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PictogramsPackage.GRADIENT_COLORED_LOCATION__COLOR, oldColor, newColor);
	...
	public void setColor(Color newColor) {
		if (newColor != color) {
			...
			if (color != null)
				msgs = ((InternalEObject)color).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PictogramsPackage.GRADIENT_COLORED_LOCATION__COLOR, null, msgs);
			if (newColor != null)
				msgs = ((InternalEObject)newColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PictogramsPackage.GRADIENT_COLORED_LOCATION__COLOR, null, msgs);
			msgs = basicSetColor(newColor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PictogramsPackage.GRADIENT_COLORED_LOCATION__COLOR, newColor, newColor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PictogramsPackage.GRADIENT_COLORED_LOCATION__COLOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PictogramsPackage.GRADIENT_COLORED_LOCATION__LOCATION_TYPE:
				return getLocationType();
			case PictogramsPackage.GRADIENT_COLORED_LOCATION__LOCATION_VALUE:
