 ...
 * </copyright>
 *
 * $Id: RoundedRectangleImpl.java,v 1.1 2010/06/16 13:25:00 mwenz Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.graphiti.mm.pictograms.impl.RoundedRectangleImpl#getCornerHeight <em>Corner Height</em>}</li>
 *   <li>{@link org.eclipse.graphiti.mm.pictograms.impl.RoundedRectangleImpl#getCornerWidth <em>Corner Width</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoundedRectangleImpl extends GraphicsAlgorithmImpl implements RoundedRectangle {
	...
	protected EClass eStaticClass() {
		return PictogramsPackage.Literals.ROUNDED_RECTANGLE;
	}
	...
	public void setCornerHeight(int newCornerHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PictogramsPackage.ROUNDED_RECTANGLE__CORNER_HEIGHT, oldCornerHeight, cornerHeight));
	}
	...
	public void setCornerWidth(int newCornerWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PictogramsPackage.ROUNDED_RECTANGLE__CORNER_WIDTH, oldCornerWidth, cornerWidth));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PictogramsPackage.ROUNDED_RECTANGLE__CORNER_HEIGHT:
				return getCornerHeight();
			case PictogramsPackage.ROUNDED_RECTANGLE__CORNER_WIDTH:
