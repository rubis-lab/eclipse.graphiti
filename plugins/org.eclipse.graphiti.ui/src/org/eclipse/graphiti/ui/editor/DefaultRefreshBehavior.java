 ...
 * {@link IDiagramContainerUI#createRefreshBehavior()} to return the instance that
 * shall be used.<br>
...
public class DefaultRefreshBehavior {
	...
	/**
	 * The associated {@link IDiagramContainerUI}. Set on construction of this
	 * class.
	 * 
	 * @since 0.10
	 */
	 ...
	 * @since 0.10
	 */
	public DefaultRefreshBehavior(IDiagramContainerUI diagramEditor, DiagramSupport diagramSupport) {
		super();
	 ...
	 * Graphiti {@link IDiagramContainerUI} when the input is set (
	 * {@link IDiagramContainerUI#setInput(org.eclipse.ui.IEditorInput)}). The default
	 ...
	 * {@link IDiagramContainerUI} after the {@link Diagram} has been reloaded. The
