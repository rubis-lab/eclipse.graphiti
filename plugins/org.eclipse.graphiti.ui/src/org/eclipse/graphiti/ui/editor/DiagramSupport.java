...
public class DiagramSupport {
	...
	void initializeGraphicalViewer() {
		...
		for (TransferDropTargetListener dropTargetListener : objectDropTargetListeners) {
			container.getGraphicalViewer().addDropTargetListener(dropTargetListener);
		}

		TransferDropTargetListener paletteDropTargetListener = createPaletteDropTargetListener();
		if (paletteDropTargetListener != null) {
			container.getGraphicalViewer().addDropTargetListener(paletteDropTargetListener);
		}
	}
	...
	protected TransferDropTargetListener createPaletteDropTargetListener() {
		return new GFTemplateTransferDropTargetListener(container.getGraphicalViewer(), container);
	}
	...
	protected List<TransferDropTargetListener> createBusinessObjectDropTargetListeners() {
		...
		result.add(new ObjectsTransferDropTargetListener(container.getGraphicalViewer()));
		return result;
	}
