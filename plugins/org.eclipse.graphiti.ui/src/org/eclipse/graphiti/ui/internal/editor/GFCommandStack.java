...
public class GFCommandStack extends CommandStack implements CommandStackListener {
	...
	public void execute(Command gefCommand) {
		...
		if (emfCommandStack instanceof WorkspaceCommandStackImpl) {
			IUndoableOperation[] originalRedoOperations = ((WorkspaceCommandStackImpl) emfCommandStack)
		...
		if (!changesDone && emfCommandStack instanceof WorkspaceCommandStackImpl) {
