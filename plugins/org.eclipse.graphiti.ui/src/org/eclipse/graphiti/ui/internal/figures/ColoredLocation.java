...
/**
 * This class is used to assign a color to a location. See
 * {@link #getLocation(int, double)} for a detailed explanation of the location.
 * 
...
public class ColoredLocation {
	...
	/**
	 * This location-type defines that the location-value is a relative
	 * percentage value in the range [0, 100]. Concretely the location is
	 * calculated by "length * (location-value / 100)".
	 */
	public static final int LOCATION_TYPE_RELATIVE = 1;

	/**
	 * This location-type defines that the location-value is an absolute value
	 * starting at the beginning of length. Concretely the location is
	 * calculated by "location-value".
	 */
	public static final int LOCATION_TYPE_ABSOLUTE_START = 2;

	/**
	 * This location-type defines that the location-value is an absolute value
	 * starting at the end of length. Concretely the location is calculated by
	 * "end - location-value".
	 */
	...
	/**
	 * Creates a new ColoredLocation for the given values. Have a look at
	 * {@link #getLocation(int, double)} for an explanation of the location-type
	 * and location-value.
	 * 
	 * @param color
	 *            The color.
	...
	/**
	 * Returns the location-value. From the location-value and the location-type
	 * the real location can be calculated.
	 * 
	...
	/**
	 * Returns the location-type. From the location-value and the location-type
	 * the real location can be calculated.
	 * 
