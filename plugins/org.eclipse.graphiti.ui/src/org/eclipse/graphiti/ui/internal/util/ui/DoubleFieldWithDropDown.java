 ...
 * a IDefaultPrintPreferences object passed in the constructor.
 * 
...
public class DoubleFieldWithDropDown extends Composite implements ModifyListener, SelectionListener {
	 ...
	 */
	public DoubleFieldWithDropDown(Composite parent, int style, IDefaultPrintPreferences prefs, int index, double[] defaults) {
		super(parent, style);
		_preferences = prefs;
		_index = index;
	...
	/**
	 * Updates control according to value in the IDefaultPrintPreferences. If it is
