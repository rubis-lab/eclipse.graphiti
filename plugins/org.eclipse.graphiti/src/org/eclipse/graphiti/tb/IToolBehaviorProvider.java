...
public interface IToolBehaviorProvider {
	 ...
	 * <p>
	 * <strong>Note</strong>: Since this element doesn't belong to the diagram,
	 * you have to be careful with the {@link Color}s and {@link Font}s used in
	 * the {@link TextStyle}s within the {@link AbstractText}. <strong>They
	 * should be created and added to the diagram beforehand</strong>,
	 * preferably in the add feature that created the given graphicsAlgorithm,
	 * i.e.:
	 * <p>
