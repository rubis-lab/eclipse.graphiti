...
public class LayoutServiceTest extends GFAbstractTestCase {
	...
	private void checkEquivalentHeight(IDimension dimension1, IDimension dimension2) {
		// On Linux the heights of the dimensions differ by one to three (15 to
		// 19), while on Windows they are the same; the difference of two
		// appeared first after moving to the own HIPP instance, it increased
		// after moving to another HIPP instance
